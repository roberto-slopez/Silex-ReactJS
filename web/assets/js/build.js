...
var _componentsPokeTableJsx = require('./components/PokeTable.jsx');

var _componentsPokeTableJsx2 = _interopRequireDefault(_componentsPokeTableJsx);

var pokemons = [{ number: 1, name: 'Bulbasaur' }, { number: 2, name: 'Ivysaur' }, { number: 3, name: 'Venusaur' }];

_react2['default'].render(_react2['default'].createElement(_componentsPokeTableJsx2['default'], { pokemons: pokemons }), document.getElementById('container'));

},{"./components/PokeTable.jsx":4,"react":160}],2:[function(require,module,exports){
/*
* Module
*/
'use strict';
...
var _PokeAvatarJsx = require('./PokeAvatar.jsx');

var _PokeAvatarJsx2 = _interopRequireDefault(_PokeAvatarJsx);
    ...
    _createClass(PokeRow, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                'li',
                { className: 'pokerow' },
                _react2['default'].createElement(_PokeAvatarJsx2['default'], { number: this.props.number }),
                this.props.name
            );
        }
    }]);
...
},{"./PokeAvatar.jsx":2,"react":160}],4:[function(require,module,exports){
'use strict';
...
var _PokeRowJsx = require('./PokeRow.jsx');

var _PokeRowJsx2 = _interopRequireDefault(_PokeRowJsx);
        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                this.props.pokemons.map(function (pokemon) {
                    return _react2['default'].createElement(_PokeRowJsx2['default'], { key: pokemon.number, name: pokemon.name, number: pokemon.number });
                })
            );
        }
    }]);
...
},{"./PokeRow.jsx":3,"react":160}],5:[function(require,module,exports){
